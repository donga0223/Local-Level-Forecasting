...
lm_fit <- function(d, target_var = "diff_wis_overall") {
  fml <- as.formula(paste0(
    target_var, " ~ log_pop_ratio + log_pct_urban + log_area_ratio + n_hsa"
  ))
  lm(fml, data = d)
}

lm_fit2 <- function(d, target_var = "diff_wis_overall") {
  fml <- as.formula(paste0(
    target_var, " ~ log_pop_ratio + log_pct_urban + n_hsa"
  ))
  lm(fml, data = d)
}

lm_fit3 <- function(d, target_var = "log_diff_wis_overall") {
  fml <- as.formula(paste0(
    target_var, " ~ log_pop_ratio + log_pct_urban + n_hsa"
  ))
  lm(fml, data = d)
...
lm_fit4 <- function(d, target_var = "log_diff_wis_overall") {
  fml <- as.formula(paste0(
    target_var, " ~ log_pop_ratio + n_hsa"
  ))
  lm(fml, data = d)
}

lm_fit5 <- function(d, target_var = "log_diff_wis_overall") {
  fml <- as.formula(paste0(
    target_var, " ~ log_pop_ratio * log_pct_urban + n_hsa"
  ))
  lm(fml, data = d)
...
lm_fit6 <- function(d, target_var = "log_diff_wis_overall") {
  fml <- as.formula(paste0(
...
cal_cv_R2(tmp1, n_k = 5, fit_fun = lm_fit)
cal_cv_R2(tmp2, n_k = 5, fit_fun = lm_fit)
cal_cv_R2(tmp3, n_k = 5, fit_fun = lm_fit)
cal_cv_R2(tmp4, n_k = 5, fit_fun = lm_fit)

cal_cv_R2(tmp1, n_k = 5, fit_fun = lm_fit3, target_var ="log_diff_wis_overall")
cal_cv_R2(tmp2, n_k = 5, fit_fun = lm_fit3, target_var ="log_diff_wis_overall")
cal_cv_R2(tmp3, n_k = 5, fit_fun = lm_fit3, target_var ="log_diff_wis_overall")
cal_cv_R2(tmp4, n_k = 5, fit_fun = lm_fit3, target_var ="log_diff_wis_overall")

cal_cv_R2(tmp1, n_k = 5, fit_fun = lm_fit4, target_var ="log_diff_wis_overall")
cal_cv_R2(tmp2, n_k = 5, fit_fun = lm_fit4, target_var ="log_diff_wis_overall")
cal_cv_R2(tmp3, n_k = 5, fit_fun = lm_fit4, target_var ="log_diff_wis_overall")
cal_cv_R2(tmp4, n_k = 5, fit_fun = lm_fit4, target_var ="log_diff_wis_overall")

cal_cv_R2(tmp1, n_k = 5, fit_fun = lm_fit5, target_var ="log_diff_wis_overall")
cal_cv_R2(tmp2, n_k = 5, fit_fun = lm_fit5, target_var ="log_diff_wis_overall")
cal_cv_R2(tmp3, n_k = 5, fit_fun = lm_fit5, target_var ="log_diff_wis_overall")
cal_cv_R2(tmp4, n_k = 5, fit_fun = lm_fit5, target_var ="log_diff_wis_overall")

cal_cv_R2(tmp1, n_k = 5, fit_fun = lm_fit6, target_var ="log_diff_wis_overall")
cal_cv_R2(tmp2, n_k = 5, fit_fun = lm_fit6, target_var ="log_diff_wis_overall")
cal_cv_R2(tmp3, n_k = 5, fit_fun = lm_fit6, target_var ="log_diff_wis_overall")
cal_cv_R2(tmp4, n_k = 5, fit_fun = lm_fit6, target_var ="log_diff_wis_overall")
...
source("code/fitting_diff_WIS_figures_ftn.R")
...
for(i in 1:4){
  pdf(paste0("Local-Level-Forecasting/paper_figures/LM_fitting_log_wis_var3_nmsa_interaction_h",i,".pdf"), 
...
png("Local-Level-Forecasting/paper_figures/LM_fitting_log_wis_var3_interaction_term_nmsa_paper_h1.png",
...
gam_res1 <- gam(formula = log_diff_wis_overall. ~  s(log_pop_ratio) + s(n_msa) , data = tmp1) 
gam_res2 <- gam(formula = log_diff_wis_overall  ~  s(log_pop_ratio) + s(n_msa) , data = tmp2) 
gam_res3 <- gam(formula = log_diff_wis_overall  ~  s(log_pop_ratio) + s(n_msa) , data = tmp3) 
gam_res4 <- gam(formula = log_diff_wis_overall  ~  s(log_pop_ratio) + s(n_msa) , data = tmp4) 
...
for(i in 1:4){
  pdf(paste0("Local-Level-Forecasting/paper_figures/GAM_fitting_log_wis_var3_nmsa_interaction_h",i,".pdf"), width = 4, height = 4)
...
png("Local-Level-Forecasting/paper_figures/GAM_fitting_log_wis_var3_interaction_term_nmsa_paper_h1.png", 
    width = 5, height = 4, units = "in", res = 600)
...
for(i in 1:4){
  pdf(paste0("Local-Level-Forecasting/paper_figures/BART_fitting_log_wis_var3_nmsa_interaction_h",i,".pdf"), width = 4, height = 4)
